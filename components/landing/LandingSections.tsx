...
import {
  ...
  Check, Plus, Receipt, LayoutDashboard,
} from 'lucide-react'
...
const PAIN_ICONS: LucideIcon[] = [Files, Clock, ShoppingBasket, HelpCircle, Bike, CalendarClock]
const FEATURE_ICONS: LucideIcon[] = [ScanLine, TrendingUp, ShoppingBasket, Truck, FileBarChart2, Download, Languages, PlayCircle]
const STEP_ICONS: LucideIcon[] = [Plus, ScanLine, Receipt, LayoutDashboard]
  ...
  return (
    <section className="bg-white">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        <SectionHead title={c.pain.title} sub={c.pain.sub} />
...
export function SolutionSection() {
  ...
  return (
    <section className="bg-slate-50">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        <SectionHead eyebrow={isZh ? '解决方案' : 'The solution'} title={c.solution.title} sub={c.solution.sub} />
...
export function FeaturesSection() {
  ...
  return (
    <section id="features" className="bg-white">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        <SectionHead eyebrow={isZh ? '功能' : 'Features'} title={c.features.title} sub={c.features.sub} />
...
export function HowSection() {
  ...
  return (
    <section className="bg-slate-50">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        <SectionHead eyebrow={isZh ? '使用流程' : 'How it works'} title={c.how.title} sub={c.how.sub} />
            ...
            return (
              <div key={i} className="relative">
                <div className="flex items-center gap-3 lg:flex-col lg:items-start">
                  <span className="relative z-10 flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-indigo-600 text-white shadow-sm ring-4 ring-slate-50">
                    <Icon size={20} />
                  </span>
